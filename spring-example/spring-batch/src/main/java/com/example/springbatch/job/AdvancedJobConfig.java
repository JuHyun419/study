...
public class AdvancedJobConfig {
    ...
    public Job advancedJob(JobExecutionListener jobExecutionListener, Step advancedStep) {
        return jobBuilderFactory.get("advancedJob")
                ...
                /* JobParameterValidator, Job이 실행되기 전 유효성 검사 */
    ...
    public JobExecutionListener jobExecutionListener() {
        return new JobExecutionListener() {
            ...
            public void beforeJob(JobExecution jobExecution) {
                log.info("JobExecutionListener - beforeJob || jobExecution: " + jobExecution.getStatus());
            }

            @Override
            public void afterJob(JobExecution jobExecution) {
                if (jobExecution.getStatus() == BatchStatus.FAILED) {
                    /* Batch Failed -> Email, Slack 등 알림 처리 */
                }
                log.info("JobExecutionListener - afterJob || jobExecution: " + jobExecution.getStatus());
            }
        };
    }
